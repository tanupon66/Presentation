const CACHE = 'dmss-faas-interactive-v2.0.0';
const CORE = [
  './index.html', './index_th.html', './presenter.html',
  './styles.css?v=2.0.0', './research_content.js?v=2.0.0', './app.js?v=2.0.0', './presenter.js?v=2.0.0',
...
async function networkFirst(request, fallbackUrl) {
  ...
  try {
    ...
    return (await cache.match(request, { ignoreSearch: true })) ||
      (fallbackUrl ? await cache.match(fallbackUrl, { ignoreSearch: true }) : Response.error());
  }
}
