const CACHE='dmss-faas-interactive-v1.2.0';
const ASSETS=['./','./index.html','./index_th.html','./styles.css','./app.js','./manifest.webmanifest','./assets/icon.svg','./assets/workflow-paper.webp','./assets/characterization-paper.webp','./assets/microscopy-paper.webp'];
