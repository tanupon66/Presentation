const CACHE='dmss-faas-interactive-v1.0.0';
const ASSETS=['./','./index.html','./styles.css','./app.js','./manifest.webmanifest','./assets/icon.svg','./assets/workflow-paper.webp','./assets/characterization-paper.webp','./assets/microscopy-paper.webp'];
