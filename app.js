(() => {
  ...
  const t = {
    en: {
      sceneWord: 'Scene',
      ofWord: 'of',
      noNotes: 'No presenter notes for this scene.',
      timerLabel: 'REHEARSAL',
      quickNotesLabel: 'QUICK NOTES',
      quickNotesButton: 'Notes',
      presenterButton: 'Presenter',
      demoStart: '▶ Demo',
      demoStop: '❚❚ Stop demo',
      demoOff: 'Demo mode off',
      demoOn: 'Demo mode on',
      demoEnds: 'Demo complete',
      presenterEyebrow: 'PRESENTER MODE',
      presenterCurrentLabel: 'Current scene',
      presenterSuggestedLabel: 'Suggested time',
      presenterCountdownLabel: 'Auto next in',
      presenterTimerLabel: 'Rehearsal timer',
      presenterNextLabel: 'Up next',
      presenterNextHint: 'Prepare the transition to the next scene.',
      presenterSceneListLabel: 'Scene list',
      presenterSceneListHint: 'Jump directly to any scene',
      presenterPrev: '← Prev',
      presenterNext: 'Next →',
      presenterRestart: 'Restart demo',
      suggestedSceneTime: 'Suggested scene time',
      keyboardHelp: 'Keyboard',
      kbNav: '← → / Space: navigate',
      kbNotes: 'N: notes',
      kbFull: 'F: fullscreen',
      kbReset: 'R: reset timer',
      kbDemo: 'D: demo mode',
      kbPresenter: 'P: presenter mode',
      ...
      signalAdsorption: 'Adsorption in progress during the 25 min contact time.',
      signalGathered: 'Magnetic particles gathered at the bottom of the tube.',
      signalCollected: 'Particles collected at the magnetic probe tip.',
      signalPeak: signal => `Conceptual transient peak (~16 s): ${signal}.`,
      expSteps: metalInfo => [
      ...
      expComplete: 'Experiment complete <span>✓</span>',
      expRun: 'Run next step <span>→</span>',
      stepOf: step => `Step ${step} of 5`,
      optimized: 'Optimized region reached',
      insideRange: 'Inside the studied experimental range',
      adsorbData: {
      ...
      samples: [
        { name:'Mint tea 1', type:'Mint tea', value:10.67 },
        { name:'Mint tea 2', type:'Mint tea', value:16.03 },
        { name:'Coffee 1', type:'Coffee', value:12.60 },
        { name:'Coffee 2', type:'Coffee', value:15.81 },
        { name:'Coffee 3', type:'Coffee', value:21.12 }
      ],
      figureData: {
      ...
      installMessage: 'This presentation can be installed and used offline.',
      installButton: 'Install'
    },
    th: {
      sceneWord: 'ฉาก',
      ofWord: 'จาก',
      noNotes: 'ไม่มีบันทึกสำหรับฉากนี้',
      timerLabel: 'ซ้อมนำเสนอ',
      quickNotesLabel: 'โน้ตย่อ',
      quickNotesButton: 'โน้ต',
      presenterButton: 'ผู้นำเสนอ',
      demoStart: '▶ เดโมอัตโนมัติ',
      demoStop: '❚❚ หยุดเดโม',
      demoOff: 'ปิดโหมดเดโม',
      demoOn: 'กำลังเล่นเดโมอัตโนมัติ',
      demoEnds: 'เดโมเล่นจบแล้ว',
      presenterEyebrow: 'โหมดผู้นำเสนอ',
      presenterCurrentLabel: 'ฉากปัจจุบัน',
      presenterSuggestedLabel: 'เวลาที่แนะนำ',
      presenterCountdownLabel: 'เปลี่ยนฉากใน',
      presenterTimerLabel: 'ตัวจับเวลาซ้อม',
      presenterNextLabel: 'ฉากถัดไป',
      presenterNextHint: 'เตรียมประโยคเชื่อมไปยังฉากถัดไป',
      presenterSceneListLabel: 'รายการฉาก',
      presenterSceneListHint: 'กดเพื่อข้ามไปฉากที่ต้องการ',
      presenterPrev: '← ก่อนหน้า',
      presenterNext: 'ถัดไป →',
      presenterRestart: 'เริ่มเดโมใหม่',
      suggestedSceneTime: 'เวลาที่แนะนำต่อฉาก',
      keyboardHelp: 'แป้นพิมพ์ลัด',
      kbNav: '← → / Space: เปลี่ยนฉาก',
      kbNotes: 'N: โน้ต',
      kbFull: 'F: เต็มจอ',
      kbReset: 'R: รีเซ็ตเวลา',
      kbDemo: 'D: โหมดเดโม',
      kbPresenter: 'P: โหมดผู้นำเสนอ',
      sourceFigure: 'ภาพอ้างอิงจากบทความ',
      waitingSorbent: metal => `รอการเติมตัวดูดซับลงในตัวอย่าง ${metal}`,
      signalDispersed: (metal, pH) => `M-OPP กระจายตัวในตัวอย่าง ${metal} (pH ${pH})`,
      signalAdsorption: 'กำลังเกิดการดูดซับระหว่างเวลาสัมผัส 25 นาที',
      signalGathered: 'อนุภาคแม่เหล็กรวมตัวอยู่ที่ก้นหลอดตัวอย่าง',
      signalCollected: 'อนุภาคถูกรวบรวมที่ปลาย magnetic probe',
      signalPeak: signal => `สัญญาณชั่วคราวเชิงแนวคิด (~16 วินาที): ${signal}`,
      expSteps: metalInfo => [
      ...
      expComplete: 'การทดลองเสร็จสิ้น <span>✓</span>',
      expRun: 'ทำขั้นตอนถัดไป <span>→</span>',
      stepOf: step => `ขั้นตอน ${step} จาก 5`,
      optimized: 'ถึงบริเวณสภาวะเหมาะสมแล้ว',
      insideRange: 'ยังอยู่ในช่วงตัวแปรที่ศึกษา',
      adsorbData: {
      ...
      samples: [
        { name:'ชามินต์ 1', type:'ชามินต์', value:10.67 },
        { name:'ชามินต์ 2', type:'ชามินต์', value:16.03 },
        { name:'กาแฟ 1', type:'กาแฟ', value:12.60 },
        { name:'กาแฟ 2', type:'กาแฟ', value:15.81 },
        { name:'กาแฟ 3', type:'กาแฟ', value:21.12 }
      ],
      figureData: {
      ...
      installMessage: 'สามารถติดตั้งและใช้งานเว็บไซต์นี้แบบออฟไลน์ได้',
  ...
  function setStaticUILanguage(){
    if(timerLabel) timerLabel.textContent = t.timerLabel;
    if(notesButton) notesButton.textContent = t.quickNotesButton;
    if(presenterButton) presenterButton.textContent = t.presenterButton;
  ...
  function updateDemoIndicator(){
    ...
    const suffix = autoplayCountdown == null ? '' : ` • ${formatTime(autoplayCountdown)}`;
    demoIndicator.textContent = `${t.demoOn}${suffix}`;
  }
  ...
  function updateChrome(){
    ...
    presenterNextTitle.textContent = nextScene ? nextScene.dataset.title : '—';
  ...
  presenterRestartDemo.addEventListener('click', () => {
    stopAutoplay();
    updateScene(0, -1);
    resetTimer();
    toggleAutoplay(true);
  ...
  document.addEventListener('keydown', e => {
    ...
    if(e.key === 'Escape'){ toggleNotes(false); togglePresenter(false); }
  });
  ...
  const metalInfo = {
    Cd: { name: lang === 'th' ? 'Cd' : 'Cd', pH: '7.0', signal: lang === 'th' ? 'การดูดกลืนของ Cd ที่ 228.8 nm' : 'Cd absorbance at 228.8 nm' },
    Pb: { name: lang === 'th' ? 'Pb' : 'Pb', pH: '4.0', signal: lang === 'th' ? 'การดูดกลืนของ Pb ที่ 283.3 nm' : 'Pb absorbance at 283.3 nm' }
  };
  let activeMetal = 'Cd';
  let expStep = 0;

  function experimentInstructions(){
    return t.expSteps(metalInfo[activeMetal]);
  }
  ...
  function applyExperimentState(step){
    ...
    if(step >= 0){
      ...
      signalCaption.textContent = t.signalDispersed(activeMetal, metalInfo[activeMetal].pH);
    } else {
      signalCaption.textContent = t.waitingSorbent(activeMetal);
    }
    if(step >= 1){
      sampleTube.classList.add('is-shaking');
      signalCaption.textContent = t.signalAdsorption;
      setTimeout(() => { if(expStep >= 2 || step >= 1) sampleTube.classList.remove('is-shaking'); }, 1300);
    }
    if(step >= 2){
      sampleTube.classList.remove('is-shaking');
      externalMagnet.classList.add('is-active');
      particles.classList.add('is-settled');
      signalCaption.textContent = t.signalGathered;
    }
    if(step >= 3){
      magneticProbe.classList.add('is-lowered');
      particles.style.opacity = '.15';
      signalCaption.textContent = t.signalCollected;
    }
    if(step >= 4){
  ...
  runExperimentButton.addEventListener('click', () => {
    if(expStep > 4){ resetExperiment(); return; }
  ...
  document.querySelectorAll('[data-exp-step]').forEach(btn => btn.addEventListener('click', () => {
    ...
    resetExperiment();
    for(let step = 0; step <= target; step++) applyExperimentState(step);
  ...
  function renderGain(metal){
    ...
    data.forEach(([name,val])=>{
      ...
      col.innerHTML=`<b>${val.toFixed(2)}×</b><i style="height:${(val/max)*82}%"></i><span>${name}</span>`;
  ...
  function selectSample(index){
    ...
    document.getElementById('sampleMrlFill').style.width=`${(s.value/50)*100}%`;
    [...sampleButtons.children].forEach((b,i)=>b.classList.toggle('is-active',i===index));
  }
  samples.forEach((s,i)=>{
    const bar=document.createElement('div');
    bar.className='sample-result-bar';
    bar.innerHTML=`<b>${s.value.toFixed(2)}</b><i style="height:${(s.value/50)*82}%"></i><span>${s.name}</span>`;
